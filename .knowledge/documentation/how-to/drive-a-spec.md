...
<span class="q-badge">Backend: GitHub or Azure Boards</span>
...
(`reviewed:`), the durable knowledge the work earned — written into `/.knowledge/standards/`,
...
!!! success "You should end with"
    ...
    - any durable rule the work proved, sitting in `/.knowledge/standards/` — not in a wiki.
...
the [command catalog](../reference/commands.md).
