...
- [automation.md](automation.md) — the repo's own local Claude Code command surface, derived
  from `.claude/commands/`. Its table is regenerated by `cq components registry reindex`; the
  plugin's thirty-eight contributed commands are documented in the product README, not here.
