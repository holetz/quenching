...
<span class="q-badge">~10 min at 4 steps</span>
<span class="q-badge">Nothing written without your OK</span>
...
The first reports where your `/.knowledge/` bundle stands (or that none exists yet); the second
...
After your OK, the alignment installs or repairs the canonical `/.knowledge/` bundle — the same
tree in every repository that adopts the plugin — and verifies its own work with the front's
validator:

```bash
cq knowledge validate .knowledge
```
