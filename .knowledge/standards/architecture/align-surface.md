...
(`/.knowledge/`), `cq design doctor` (`/.design/`), `cq components doctor`/`lint` (`.claude/`) —
...
[§The aligned-front column](#the-aligned-front-column) records the dependency: `/.knowledge/` still
