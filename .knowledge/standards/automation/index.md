...
| [dependency-sweep.md](dependency-sweep.md) | O contrato da varredura de dependências por sub-agente que roda entre a captura e o banco shape do /quenching:specs:develop — gatilho, perfil de ferramentas, entregável, e a persistência do mapa com a data que ele carrega |
