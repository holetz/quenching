...
audience: both
authority: current
source: spec remover-secao-stray-de-um-documento (task 2.2) — o `sp-stray-heading` cujo remédio declarado aconselhava duas ações que a própria CLI que o emitia recusava com exit 2, medido em 2026-08-17
