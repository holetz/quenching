...
# the command surface
python3 assets/bin/cq --root . components doctor --json                  # 28 commands, no findings
...
What the twenty-eight commands are, what each front gets, the cost model and the install/upgrade
