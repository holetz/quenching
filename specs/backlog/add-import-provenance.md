...
description: Deferred from the docs-verification-layer plan — source_uri plus a content hash so a changed source is detectable and a re-import enriches instead of duplicating
timestamp: 2026-07-25
tags: [docs, import, provenance]
---
