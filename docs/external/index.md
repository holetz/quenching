...
(external)" — distinct from [standards/](../standards/index.md) ("how **WE** do it") and
[catalog/](../catalog/index.md) ("our **data**"). Example: the text of a regulation (a
PDF) lives in [regulations/](regulations/index.md) via a sidecar; **our interface** to it
(how we implement it) lives in [standards/mlops/](../standards/mlops/index.md).
