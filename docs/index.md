...
**quenching** is a Claude Code plugin. Point it at a repository and its knowledge, its plans and
its automation each converge onto one canonical, verifiable structure — probed first, planned
...
- **Understand why** — the three fronts, the OKF bundle, the provider-owned spec lifecycle:
  [the explanations](explanation/index.md).
- **Look it up** — all thirty-eight commands, the local automation registry:
