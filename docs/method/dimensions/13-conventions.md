...
Conventions are the **house rules the repo already follows** — import style, language,
naming, pins, the *"X defines Y"* rule. The dimension is about making the implicit explicit
and keeping each rule in exactly one owning doc.
