...
resource: plugins/claude-quenching/assets/hooks/okf-validate.py, plugins/claude-quenching/assets/references/docs-align/conformance.md, plugins/claude-quenching/commands/docs/status.md
