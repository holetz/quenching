...
`cwd: plugins/quenching` and `verify: … cq knowledge validate docs`. The bundle is at the
...
[/docs/standards/agents/communication.md](../agents/communication.md) §What it governs forces
...
[/docs/standards/quality/prose-verify-pins-wording.md](../quality/prose-verify-pins-wording.md)
...
Resource activity rises structurally on any branch that edits a path some standard governs — the resource
