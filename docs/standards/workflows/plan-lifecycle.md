...
the emergent `/docs/` was **written**, the spec was **distilled**, and the pre-merge gate ran
...
same run as the promote. The distillation line qualifies on the second clause too — `/docs/log.md`
