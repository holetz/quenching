...
* [Building with the tool being built](building-with-the-tool-being-built.md) — o `cq` que marca a caixa é o que a task edita: a janela em que ele fica inexecutável torna duas tasks inseparáveis, e o chão que se move obriga a capturar antes de editar.
