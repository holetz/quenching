...
- vs. [standards/](../standards/index.md) — standards are "how **WE** do it" (a
...
- vs. [external/](../external/index.md) — reference is facts about a **specific
...
- vs. [vision/](../vision/index.md) — vision is future **direction**; knowledge is
