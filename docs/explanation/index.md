...
- **[The operating model](operating-model.md#the-operating-model)** — five aligned local fronts,
  the provider-owned specs front, probe-first, and why the git pillar deliberately has no align.
