...
description: The repo's local Codex automation surface — every command, derived from .agents/skills/
...
`.agents/skills/**/*.md` frontmatter. Edit outside the markers only; a hand edit inside
...
<!-- MOLD (quenching · automation registry) → becomes
     ...
     `../../references/components-command-new/taxonomy.md` §registry: the zone lists
