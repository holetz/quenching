...
resource: <the surfaces this rule governs — .agents/settings.json hooks + command frontmatter hooks + .agents/hooks/>
...
<!-- MOLD (quenching · hooks standard) → becomes `/.knowledge/standards/automation/hooks.md` in a
     ...
     plugin (`../../references/components-command-new/capabilities.md` §Hooks);
