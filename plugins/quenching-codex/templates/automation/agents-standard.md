...
description: When work becomes a subagent, the definition contract for .agents/agents/, and how the surface is inventoried
resource: <the surface this rule governs — .agents/agents/>
...
source: <who agreed the rule — e.g. skill-agent-new first run, team decision>
maintainer: <owner>
---
...
One definition per file at `.agents/agents/<name>.md`, minted by `quenching-components-agent-new` under
...
<!-- MOLD (quenching · agents standard) → becomes `/.knowledge/standards/automation/agents.md` in a
     ...
     (`../../references/components-command-new/capabilities.md` §Subagents); this
