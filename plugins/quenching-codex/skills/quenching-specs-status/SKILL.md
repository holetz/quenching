...
description: "Read the provider-owned specs front without writing. Use when the user asks for \"specs status\", \"the status of the specs front\", or \"provider configuration\"."
---
