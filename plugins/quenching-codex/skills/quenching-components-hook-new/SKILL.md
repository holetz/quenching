...
Walk [capabilities.md](../../references/components-command-new/capabilities.md)
...
### 7. Verify the wiring
```bash
python3 -m json.tool .agents/settings.json          # the merge left valid JSON
echo '{"hook_event_name":"<other>"}' | python3 .agents/hooks/<name>.py   # fast path → {}
```
...
[knowledge-add/homes.md](../../references/knowledge-add/homes.md). Report: the
