...
[components-command-eval/evaluation.md](../../references/components-command-eval/evaluation.md), adopted from Anthropic's `skill-creator` so
...
### 3. Derive the cases
Per [components-command-eval/evaluation.md](../../references/components-command-eval/evaluation.md) §Writing cases: one case per branch, each
...
Write `evals.json` into the tree mirroring the command's path — `.agents/evals/<path>/` in a
target repo, `../../assets/evals/<path>/` in this plugin
([components-command-eval/evaluation.md](../../references/components-command-eval/evaluation.md)
