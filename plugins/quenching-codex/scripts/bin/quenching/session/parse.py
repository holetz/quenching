...
-----------------------
One JSONL file per session at `~/.codex/projects/<encoded-cwd>/<session-id>.jsonl`, one
...
def silence_refusal(model: dict) -> dict | None:
    ...
    drift in Codex's undocumented JSONL would otherwise land as a clean run forever,
