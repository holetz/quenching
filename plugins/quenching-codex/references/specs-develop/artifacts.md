...
once in
[spec-driven.md](../../references/specs-develop/spec-driven.md) and are
...
([execution-delegation.md](../../references/specs-execute/execution-delegation.md) §Declared
...
- **Within what the dependency order allows, group by file.** A section is the unit execution
  ...
  ([execution-delegation.md](../../references/specs-execute/execution-delegation.md) §The cost of
