...
non-`docs/` referrers (skills, `AGENTS.md`, prose links) the rename will edit. The OK covers
...
([convergence.md](../../references/align/convergence.md) §The cycle-authorization contract) replaces only the batch gate
...
- `summary:` → `description:`
- `updated:` → `timestamp:`
- add non-empty `type:` (from the home's vocabulary in [taxonomy.md](../../references/knowledge-align/taxonomy.md))
