...
The layer's reach and budget are declarations in `.agents/quenching.json` under `layers`; the
...
`../../templates/proof/` are the canonical shapes for those two generated
files.
