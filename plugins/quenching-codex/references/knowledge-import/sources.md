...
[`docs-add/homes.md`](../../references/knowledge-add/homes.md), which this
skill cites.
...
[`docs-add/homes.md`](../../references/knowledge-add/homes.md) deliberately
...
See the model policy in [README.md §model-policy](../../README.md#model-policy).
