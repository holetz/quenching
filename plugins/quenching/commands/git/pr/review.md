...
description: >-
  ...
  and mark it resolved once the fix is committed. Use when the user asks to "resolve PR comments",
...
allowed-tools: Bash(gh pr view:*), Bash(gh repo view:*), Bash(gh api graphql:*), Read, Edit, AskUserQuestion
---
