...
description: >-
  ...
  one confirmation. Not for: opening or updating a PR → /quenching:git:pr:create; syncing or
  resolving divergence → /quenching:git:sync; merging → /quenching:git:merge.
argument-hint: [branch|--remote remote branch]
allowed-tools: Bash(git status:*), Bash(git branch --show-current:*), Bash(git remote:*), Bash(git rev-parse:*), Bash(git rev-list:*), Bash(git log:*), Bash(git ls-remote:*), Bash(git push:*), Bash(python3:*), Read, AskUserQuestion
---
