---
description: Drain the project's Claude Code memory into the OKF bundle, then clear it. Triggers on "convert the memory into docs", "move project memory into the knowledge base", "flush the memory into docs".
