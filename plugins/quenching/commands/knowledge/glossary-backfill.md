---
description: Sweep the whole bundle to backfill knowledge/glossary.md with missing terms. Triggers on "scan the docs for glossary terms", "backfill the glossary", "find terms we never added to the glossary". Not for: ONE term on demand → /quenching:knowledge:define.
