...
Invoke via the **Skill** tool under its registry name **`quenching:docs:align`** — the
...
**`quenching:specs:align`** with the same authorization declaration. Record its counts **and** its reported-not-applied residue
...
**`quenching:skill:align`** with the same authorization declaration. Its rule + registry creation lands in the bundle Front 1 just
