...
Invoke via the **Skill** tool under its registry name **`quenching:docs:align-and-update`**
...
**`quenching:specs:align-and-update`** with the same declaration. Record its
...
Skip if the surface is empty. Otherwise invoke **`quenching:skill:align-and-update`** with
