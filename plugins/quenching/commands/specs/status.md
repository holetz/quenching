...
description: >-
  ...
  status of the specs front", or "provider configuration". Not for: developing or executing a spec →
  /quenching:specs:develop, /quenching:specs:execute; ranking the front → /quenching:specs:triage.
