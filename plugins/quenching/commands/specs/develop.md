---
description: Develop an existing spec — compose it to ready, argue with it, approve it. Triggers on "develop this spec", "refine the spec", "fill in the missing sections", "approve this spec", "poke holes in this". Not for: defining N specs at once → /quenching:specs:develop-batch; creating a spec or executing one.
