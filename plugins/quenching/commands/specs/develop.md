...
`specs.py show --spec <slug> --section "<Heading1>" --section "<Heading2>" ...` — never `--full`
and never assume filenames. Then, if the repo carries an OKF bundle (`docs/index.md` with
