---
description: Refactor CLAUDE.md/AGENTS.md into thin pointers over the /.knowledge/ bundle. Triggers on "refactor CLAUDE.md", "slim down CLAUDE.md", "move CLAUDE.md content into docs", "align CLAUDE.md/AGENTS.md with /.knowledge/".
