---
description: Refactor CLAUDE.md/AGENTS.md into thin pointers over the /.docs/ bundle. Triggers on "refactor CLAUDE.md", "slim down CLAUDE.md", "move CLAUDE.md content into docs", "align CLAUDE.md/AGENTS.md with /.docs/". Not for: writing a standalone doc into the bundle → /quenching:knowledge:add.
