...
retires one — `/quenching:skill:eval`'s own measurement (`skill-evaluation.md` §Description
tuning) is the one edit it authorizes. A trigger that looks like sediment is **reported** with the
