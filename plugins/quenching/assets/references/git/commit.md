...
[execution.md](${CLAUDE_PLUGIN_ROOT}/assets/references/specs-execute/execution.md) §The section squash
...
- `/quenching:specs:execute` ticks the box **first**, then commits the code and the ticked box together. The
  ...
  boundary
  ([execution.md](${CLAUDE_PLUGIN_ROOT}/assets/references/specs-execute/execution.md) §The section
