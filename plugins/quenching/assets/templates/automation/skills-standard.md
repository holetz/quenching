...
resource: <the surface this rule governs — .claude/commands/>
...
the plugin (`${CLAUDE_PLUGIN_ROOT}/assets/references/components-command-new/capabilities.md`) and is
...
<!-- MOLD (quenching · skills standard) → becomes
     ...
     (`${CLAUDE_PLUGIN_ROOT}/assets/references/components-command-new/taxonomy.md`); this standard is the
