...
description: >-
  ...
  the human states → quenching-add; installing/aligning the docs structure →
  quenching-align; draining ~/.claude project memory → quenching-import-memory.
when_to_use: >-
  importing an external source (files/folders/URLs) into an existing OKF bundle as multiple
  minted concept docs. A batch fan-out of quenching-add; one human-stated fact is
  quenching-add, project-memory migration is quenching-import-memory.
allowed-tools: Read, Grep, Glob, WebFetch, Write, Edit, Task
user-invocable: false
---

# quenching-import — import an external source into the OKF bundle
...
`quenching-add`**: [`quenching-add/references/homes.md`](../quenching-add/references/homes.md)
...
a doc (correctable), unlike `quenching-import-memory` (see the model policy in
