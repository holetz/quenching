...
- **How "good" looks:** conventions **explicit and unique**, each with an owning doc in the standards; CLAUDE.md cites them with a short directive + link.

- **Detection:** read the code/naming docs from the standards; cross-reference with what CLAUDE.md cites.
