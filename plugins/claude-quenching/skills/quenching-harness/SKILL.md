...
`quenching-align` first if not). It also **creates** a thin subfolder `CLAUDE.md` where discovery
...
**stop** and offer `quenching-align` first. List every harness file found.
...
Per `quenching-align`'s migration doctrine
([../quenching-align/references/migration.md](../quenching-align/references/migration.md) §3–4):
