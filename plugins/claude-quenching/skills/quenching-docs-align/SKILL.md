...
# quenching-docs-align — force the knowledge base into OKF shape
...
- **Install the operator manual** — copy `${CLAUDE_PLUGIN_ROOT}/assets/docs/QUENCHING.md` to
  ...
  The manual is **exempt** from OKF ([references/conformance.md](references/conformance.md)) —
...
`quenching-docs-documentation-build` (`/docs:documentation:build`): every later update, nav
