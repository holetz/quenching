...
description: >-
  ...
  information into the base", "add a standard/convention", "add a catalog
  table", "draft an announcement", "add a reference doc", or
  ...
  parking a task in the backlog → openspec-backlog.
when_to_use: >-
...
# quenching-add — add new knowledge, OKF-conformant
...
(the tail step every capture runs; on-demand counterpart `quenching-define`, bulk counterpart
