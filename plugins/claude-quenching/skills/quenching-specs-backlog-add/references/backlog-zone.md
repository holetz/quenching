...
the backlog skills' own on-write check; both `quenching-specs-backlog-add` and
`quenching-specs-backlog-triage` cite it. The log entry a capture/triage appends still lands in the
