---
type: <REQUIRED — the concept kind; pick the home's type from references/homes.md, e.g. standard|decision|vision|task|documentation|knowledge|reference|system|schema|table|sidecar>
