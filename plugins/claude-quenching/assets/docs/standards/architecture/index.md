...
lint, symbols) live in [../code/](../code/index.md); still-open decisions live in
[decisions/](/docs/decisions/index.md). One standard per file (files, not sub-folders);
each carries `type: standard` + a derived `resource:`; add each to [../index.md](../index.md).
